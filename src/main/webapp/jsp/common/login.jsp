...
<a href="${pageContext.request.contextPath}/controller?command=change_language">ru</a> | <a href="${pageContext.request.contextPath}/controller?command=change_language">en</a>
</div>
