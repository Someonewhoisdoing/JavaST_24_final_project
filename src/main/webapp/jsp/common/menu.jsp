...
<img class="rounded w-75 h-75" src="<c:url value="/static/image/cup.jpg"/>" alt="Coffee paper cup image"/>
<div class="card-body">
...
<div class="container">
<a href="${pageContext.request.contextPath}/controller?command=to_menu_page?page=1">1</a>
<a href="${pageContext.request.contextPath}/controller?command=to_menu_page?page=2">2</a>
<a href="${pageContext.request.contextPath}/controller?command=to_menu_page?page=3">3</a>
</div>
